  ...
  return (
    <div className="relative w-full aspect-square md:aspect-auto md:h-[640px] flex items-center justify-center">
      ...
      <div className="relative z-10 w-[85%] sm:w-full max-w-[320px] sm:max-w-[480px] mx-auto">
        ...
        {/* Floating Dashboard Card - Strategic Results */}
        <motion.div 
        ...
        >
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h3 className="text-[12px] sm:text-[14px] font-bold text-brand-primary tracking-tight">Dashboard tổng quan</h3>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="space-y-1">
                <div className="text-[10px] sm:text-[11px] font-bold text-brand-secondary/60 uppercase tracking-widest">Doanh thu</div>
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl sm:text-3xl font-bold text-brand-accent">+286%</span>
                  <span className="flex items-center text-[9px] sm:text-[10px] font-medium text-brand-secondary/60">vs 90 ngày <ArrowUpRight className="w-2.5 h-2.5 text-brand-highlight ml-0.5" /></span>
                </div>
              </div>
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <div className="text-[10px] sm:text-[11px] font-bold text-brand-secondary/60 uppercase tracking-widest">Chi phí / Lead</div>
              <div className="flex items-baseline gap-2">
                <span className="text-2xl sm:text-3xl font-bold text-green-600">-42%</span>
                <span className="text-[9px] sm:text-[10px] font-medium text-brand-secondary/60">vs 90 ngày</span>
              </div>
              <div className="h-1 w-16 sm:w-24 bg-green-500 rounded-full" />
            </div>
            ...
            <div className="bg-brand-highlight/[0.03] border border-brand-highlight/20 rounded-xl p-3 sm:p-4 relative overflow-hidden">
               <div className="flex items-center justify-between mb-1 sm:mb-2">
                 <span className="text-[10px] sm:text-[11px] font-bold text-brand-highlight uppercase tracking-widest">ROAS</span>
                 <div className="w-1.5 h-1.5 rounded-full bg-brand-highlight" />
               </div>
               <div className="text-2xl sm:text-3xl font-bold text-brand-highlight mb-1">4.6x</div>
               <div className="text-[9px] sm:text-[10px] font-bold text-brand-highlight/70 uppercase tracking-widest">Tối ưu lợi nhuận</div>
            </div>
          </div>
        </motion.div>
